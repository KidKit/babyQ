...
- (void)testInternetConnection
{
    ...
    internetReachableFoo.reachableBlock = ^(Reachability*reach)
    {
        ...
        birthdayField.enabled = YES;
        dueDateField.enabled = YES;
        yesDelivered.enabled = YES;
        noDelivered.enabled = YES;
        babyPoundsField.enabled = YES;
        babyOuncesField.enabled = YES;
        babyInchesField.enabled = YES;
        vaginalButton.enabled = YES;
        cSectionButton.enabled = YES;
        complication1Button.enabled = YES;
        complication2Button.enabled = YES;
        complication3Button.enabled = YES;
        complication4Button.enabled = YES;
        complication5Button.enabled = YES;
        complication6Button.enabled = YES;
    };
    ...
    internetReachableFoo.unreachableBlock = ^(Reachability*reach)
    {
        ...
        birthdayField.enabled = NO;
        dueDateField.enabled = YES;
        yesDelivered.enabled = YES;
        noDelivered.enabled = YES;
        zipCodeField.enabled = NO;
        babyPoundsField.enabled = NO;
        babyOuncesField.enabled = NO;
        babyInchesField.enabled = NO;
        vaginalButton.enabled = NO;
        cSectionButton.enabled = NO;
        complication1Button.enabled = NO;
        complication2Button.enabled = NO;
        complication3Button.enabled = NO;
        complication4Button.enabled = NO;
        complication5Button.enabled = NO;
        complication6Button.enabled = NO;
    };
